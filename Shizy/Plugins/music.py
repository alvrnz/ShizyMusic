...
from Shizy.config import SUPPORT_GROUP, UPDATE_CHANNEL, OWNER_USERNAME
from pyrogram.types import Message, Voice, InlineKeyboardButton, InlineKeyboardMarkup, CallbackQuery
from pyrogram.errors import UserAlreadyParticipant
from Shizy.Modules.cache.admins import set
from Shizy.Modules.cache import clientbot, queues
from Shizy.Modules.cache.clientbot import client as USER
from Shizy.Modules.helpers.admins import get_administrators
from youtube_search import YoutubeSearch
from Shizy.Modules.cache import converter
from Shizy.Modules.cache import youtube
from Shizy.config import DURATION_LIMIT, que, SUDO_USERS
from Shizy.Modules.cache.admins import admins as a
from Shizy.Modules.helpers.decorators import errors, authorized_users_only
from Shizy.Modules.helpers.errors import DurationLimitError
from Shizy.Modules.helpers.gets import get_url, get_file_name
...
async def generate_cover(requested_by, title, views, duration, thumbnail):
    ...
    img = Image.open("resource/Shizy.png")
    ...
    image4.text((10, 10), "Shizy MUSIC", fill="white", font = font1, align ="left") 
...
async def admincache(client, message: Message):
    ...
    await message.reply_photo(
                              photo="https://telegra.ph/file/0a7aa2dce7972be90b75d.jpg",
